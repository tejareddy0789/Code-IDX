  ...
  const plans = [ 
    {
      name : 'Basic Plan',
      price : 'Free',
      description : 'Ideal for individual use or small teams just getting started.',
      features : [ 'Upto 1 team members',
        '5GB storage',
        'Basic analytics',
        'Email support',
        'No API access',
  ...
  
    {
      name : 'Professional',
      price : 69.99,
      description : 'Best for growing businesses or Startups',
      features : [
    ...
    className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          Get started with the plan that scales with you 14 day free trial included.
          </p>
        </div>
          ...
          {plans.map((plan, key) => (
            <div key={key}
              className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full ${
                ...
                <ul className="flex flex-col space-y-3 sm:space-y-4 mb-6 sm:mb-8">
